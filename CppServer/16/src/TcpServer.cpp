...
TcpServer::TcpServer() {
  ...
  unsigned int size = 3; //std::thread::hardware_concurrency();
...
const std::unordered_map<int, std::unique_ptr<Connection>>& TcpServer::GetClients() const { return connections_;}
